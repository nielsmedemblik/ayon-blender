...
- Publish the look to generate a JSON manifest plus FBX and texture resources per material; meshes must carry a `cbId` custom property so they can be re-identified later.
